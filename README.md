...
- **Ordini sbagliati o di prova**: finché non è stata registrata nessuna consegna, dalla finestra "Vedi" dell'ordine il titolare può **eliminarlo** oppure **riportarlo nel piano** (l'ordine sparisce e le voci tornano nella lista riordino per essere corrette e riconfermate). Dopo una consegna parziale, le voci in attesa si annullano solo dalla registrazione della consegna.
