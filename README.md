...
- **In ordine**: le giacenze mostrano i ml già ordinati ai fornitori e non ancora ricevuti (badge sulla cella del negozio di consegna, colonna "In ordine" ordinabile, numero cliccabile in testata). Le proposte automatiche ne tengono conto: se la merce è già in arrivo non si ripropone un riordino e la spunta di massa salta quelle voci.
